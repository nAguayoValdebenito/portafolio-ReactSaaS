    ...
    <header className="bg-surface dark:bg-surface shadow-sm border-b border-outline-variant dark:border-outline docked full-width top-0 z-50 sticky">
      <div className="flex justify-between items-center h-20 w-full px-margin-desktop max-w-container-max mx-auto">
        <div className="flex items-center gap-gutter">
          <a className="font-headline-md text-headline-md font-bold text-primary dark:text-primary-fixed" href="#">PredictiveSaaS</a>
        </div>
        ...
        <div className="hidden md:flex items-center gap-4">
          <a className="font-label-md text-label-md text-primary hover:text-primary-container transition-colors" href="#">Log In</a>
          <a className="font-label-md text-label-md bg-primary-container text-on-primary hover:bg-primary transition-all duration-300 hover:scale-105 hover:shadow-lg px-4 py-2 rounded-lg shadow-sm" href="#">Create Account</a>
        </div>
